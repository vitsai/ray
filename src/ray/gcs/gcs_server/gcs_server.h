...
class GcsServer {
 public:
  ...
  const GcsAutoscalerStateManager &GetAutoscalerStateManager() {
    RAY_CHECK(gcs_autoscaler_state_manager_ != nullptr)
        << "Autoscaler state manager has not been initialized.";
